...
import { 
  Settings2, Search, Filter, LogOut, Loader2, BarChart3, TrendingUp, 
  ShieldCheck, Info, Calendar, Flame, AlertTriangle, Activity, 
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-[10px] text-slate-500 font-mono">
              ...
              LIVE DATA STREAMING
              <span className="ml-2 border-l border-slate-800 pl-2">V2.0.0-ENHANCED</span>
            </div>
          </div>
        </div>
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-4 py-1 rounded-full text-xs font-black uppercase ${
                          ...
                          {selectedWeeklyStockData.weekly_trend}
                        </span>
                      </div>
